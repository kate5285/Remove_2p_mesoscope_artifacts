...
% mousedate = 'HS_Ai203_2/220531/';
% mousedate = 'HS_Chrome2f_3/220923/';

%mousedate = 'MU31_2/230106/';
% mousedate = 'MU31_1/230106/';
% mousedate = 'MU31_2/230107/';
% mousedate = 'MU31_1/230107/';
% mousedate = 'MU31_1/230108/';
% mousedate = 'MU31_2/230109/';
% mousedate = 'MU31_1/230109/';
% mousedate = 'MU31_2/230110/';
% mousedate = 'MU31_1/230110/';
% mousedate = 'MU31_2/230111/';
mousedate = 'MU31_1/230111/';

disp(mousedate)

drivepath = 'S:/MesoHoloExpts/';
...
% %MU31_1/230106/
% allfoldernames = {'101','retinotopy0','staticICtxi0','staticgratings','staticgratings12', ...
%     'staticICtxi1','RFcircleC','sizeC',...
%     'stimtest_SGholo_5cph_nogating','SGholo', 'stimtest_ICholo_5cph_gating', 'ICholo'};
% nexpts = {'x', '000', '001', '002', '003', '004', '005', '006', 'x', 'x', 'x', 'x'};
% %MU31_2/230107/
% allfoldernames = {'101','retinotopy0','staticICtxi0','staticgratings','staticgratings12', ...
%     'staticICtxi1','sizeC','RFcircleC','stimtest_ICholo_5cph','ICholo','SGholo'};
% nexpts = {'x', '000', '001', '002', '003', '004', '005', '006', 'x', 'x', 'x'};
% %MU31_1/230107/
% allfoldernames = {'101','retinotopy0','staticICtxi0','staticgratings','staticgratings12', ...
%     'staticICtxi1','sizecircleC','RFcircleC','stimtest_ICholo_5cph','ICholo','SGholo'};
% nexpts = {'x', '000', '001', '002', '003', '004', '005', '006', 'x', 'x', 'x'};
% %MU31_1/230108/
% allfoldernames = {'101','retinotopy0','staticICtxi0','staticgratings','staticgratings12','staticICtxi1', ...
%     'RFcircleC','sizecircleC','stimtest_ICholo_5cph','ICholo','SGholo'};
% nexpts = {'x', '000', '001', '002', '003', '004', '005', '006', 'x', 'x', 'x'};
% %MU31_2/230109/
% allfoldernames = {'101','retinotopy0','staticICtxi0','staticgratings','staticgratings12', ...
%     'staticICtxi1','sizecircleC','RFcircleC', ...
%     'stimtest_ICholo_5cph','stimtest_ICholo_5cph_try2','stimtest_ICholo_5cph_try3','stimtest_ICholo_5cph_try4', ...
%     'stimtest_ICholo_1cph','stimtest_SGholo_5cph','SGholo','ICholo'};
% nexpts = {'x', '000', '001', '002', '003', '004', '005', '006', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'};
% %MU31_1/230109/
% allfoldernames = {'101','retinotopy0','staticICtxi0','staticgratings','staticgratings12', ...
%     'staticICtxi1','sizecircleC','RFcircleC','stimtest_ICholo_5cph','ICholo','SGholo'};
% nexpts = {'x', '000', '001', '002', '003', '004', '005', '006', 'x', 'x', 'x'};
% %MU31_2/230110/
% allfoldernames = {'101','stimtest_segmentMasks_26targets','retinotopy0','staticICtxi0', ...
%     'staticgratings','staticgratings12','staticICtxi1','sizecircleC','RFcircleC', ...
%     'stimtest_ICholo_5cph','ICholo','SGholo'};
% nexpts = {'x', 'x', '000', '001', '002', '003', '004', '005', '006', 'x', 'x', 'x'};
% %MU31_1/230110/
% allfoldernames = {'101','retinotopy0','staticICtxi0','staticgratings','staticgratings12', ...
%     'staticICtxi1','sizecircleC','RFcircleC','stimtest_ICholo_5cph', ...
%     'ICholo','ICholo2','SGholo','SGholo2'};
% nexpts = {'x', '000', '001', '002', '003', '004', '005', '006', 'x', 'x', 'x', 'x', 'x'};
% %MU31_2/230111/
% allfoldernames = {'101','retinotopy0','staticICtxi0','staticgratings','staticgratings12', ...
%     'staticICtxi1','sizecircleC','RFcircleC','stimtest_ICholo_5cph','ICholo','SGholo'};
% nexpts = {'x', '000', '001', '002', '003', '004', '005', '006', 'x', 'x', 'x'};
% %MU31_1/230111/
allfoldernames = {'retinotopy0','staticICtxi0','staticgratings','staticgratings12', ...
    'staticICtxi1','sizecircleC','RFcircleC','stimtest_ICholo_5cph','ICholo','SGholo'};
nexpts = {'000', '001', '002', '003', '004', '005', '006', 'x', 'x', 'x'};
...
[holoreqfile,holoreqpath] = uigetfile([onlinepath '*.mat'], 'choose holoRequest file fron onlinepath');
...
cropedgethr = 50; % 0 to not restrict any cells

% copy pasted from mesoscope_json_from_scanimage
[reftif, refpath] = uigetfile([mesoSIpath '*.tif'], 'SELECT REFERENCE IMAGE FOR COMPUTING Lx and Ly');
...
offplane = double( 1 + cat(1, offstat.iplane));
...
imoffroi = zeros(offline.ops.Ly, offline.ops.Lx);
...
if restrictofffov
    validoffXYcells = validoffXYcells & offroictr(:,2)>offxlb & offroictr(:,2)<=offxub & ...
        offroictr(:,1)>offylb & offroictr(:,1)<=offyub;
end
...
addpath(genpath('G:\My Drive\CODE\helperfunctions\npy-matlab-master'))
% a = rand(5,4,3);
% writeNPY(a, 'a.npy');
% b = readNPY('a.npy');
...
%     % disp([pres2p.tiffns(tiffnind(f)).folder '/' pres2p.tiffns(tiffnind(f)).name])
    ...
    fnsplit = strsplit(suite2pfilelist(f,1:dotindex-1), '_');
    fileindex(f) = str2num(fnsplit{end});
    
    fileparts = strsplit(temps2pfn, '/');
    folderind = find(strcmp(allfoldernames, fileparts{end-1}));
